    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('CHAMBERS_ADMIN', 'Chambers Admin'), ('BARRISTER', 'Barrister'), ('CLERK', 'Clerk'), ('SOLICITOR', 'Solicitor'), ('PUBLIC', 'Public')], default='PUBLIC', max_length=20)),
